...
- `--autonomous` — suppress all interactive questions; passed through to the **git-commit** sub-agent so it uses its best judgment without asking
...
/git-commit-push --autonomous
/git-commit-push --autonomous --issue 42
```
