...
| 2026-09-19 | `ai-understanding` added — encodes discovered knowledge into the gitignored `.context/understandings/` store; export to a tracked path is a separate approved step. | |
