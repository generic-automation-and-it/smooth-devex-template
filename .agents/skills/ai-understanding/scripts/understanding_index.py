...
file stays individually addressable by the question it answers. The index groups by subject but lists
every unit, because knowledge is retrieved by the question it answers rather than by the
subject that happened to produce it.
